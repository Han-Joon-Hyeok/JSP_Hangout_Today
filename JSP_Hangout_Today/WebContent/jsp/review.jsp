					...
					<div class="user-response">
						<div class="icon-area">
							<span class="icon like"></span> <span>좋아요 <span
								class="like_num">0</span></span> <span>댓글 <span
								class="comment_num">0</span></span>
						</div>
						<%
							try {
						...
						<div class="comments">
							<div class="user">
								...
								<div class="user-area">
									<span class="user-name"><%=rsReply.getString("name")%></span>
									<span class="time"> <%=rsReply.getString("postdate")%></span>
							...
							<form action="../function/addReply.jsp">
								<div class="icon-area">
									<input type="hidden" id="reviewID" name="reviewID"
										value="<%=rsReview.getInt("reviewid")%>"> <span
										class="icon">🤗</span> <input type="text" name="text"
